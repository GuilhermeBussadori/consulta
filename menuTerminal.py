...
grupo_dict={
'Discord': 'https://discord.gg/dAsuyJENv6'}
...
def menu() -> None:
    while Exit == False:
        clear(clean)
        option = str(input('''
Bem-Vindo(a) ao {0}YoshiConsultas|Paid{1}
Seu Endereço de IP : {2}{3}{4}
____________________________
|{5}1{6} Consulta de DDD      |
|{7}2{8} Consulta de CNPJ     |
|{9}3{10} Consulta de CEP      |
|{11}4{12} Consulta de IP       |
|{13}5{14} Consulta Bancária    |
|{15}6{16} Covid-19             |
|{17}7{18} Consulta de Placa    |
|{19}8{20} Consulta de BIN      |
|{21}9{22} Consulta de CPF      |
|{23}10{24} Consulta de Nome    |
|___________________________|
|{25}99{26} APIs                |
|{27}98{28} Redes Sociais       |
|{29}00{30} Sair                |
|___________________________|
>>> '''.format(B, C, B, ipmenu, C, B, C, B, C, B, C, B, C, B, C, B, C, B, C, B, C, B, C, B, C, R, C, G, C, R, C)))
